...
# You may have noticed, we need to crop the raster, SprugeFull, and FremontWater to just fit inside Fremont County Boarders. Let's clean up our data. 
...
# You try it - Elevation map - all Fremont Co
```{r - Plot all data into one lovely map w/ Elevation,message=F}

  # You can do this for Elevation too, but 1st mask it first to Fremont Co!
