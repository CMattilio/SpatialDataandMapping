...
#Sarah read in 
SpurgeFull <- readOGR(dsn = "/Users/swaybright/Desktop/SpatialDataandMapping", layer = "SpurgeFull")
bbox(SpurgeFull)
...
FremontCo <- readOGR(dsn = "/Users/swaybright/Desktop/SpatialDataandMapping", layer = "FremontCo")
StudyExtent <- readOGR(dsn = "/Users/swaybright/Desktop/SpatialDataandMapping", layer = "FremontBuff1000m")
bbox(FremontCo)
bbox(StudyExtent)
...
FremontCoRoad <- readOGR(dsn = "/Users/swaybright/Desktop/SpatialDataandMapping", layer = "FremontCoRoad")
# Check projection
...
# Read in main roads
FremontMRoads <- readOGR(dsn = "/Users/swaybright/Desktop/SpatialDataandMapping", layer = "FremontMainRoads")
# Check projection
...
# Read in waterways
FremontWater <- readOGR(dsn = "/Users/swaybright/Desktop/SpatialDataandMapping", layer = "WaterwaysFremont")
# Check projection
...
FremontAgencies <- readOGR(dsn = "/Users/swaybright/Desktop/SpatialDataandMapping", layer = "FremontAgencies")
# Check projection
...
# Import elevation
Elevation <- raster("/Users/swaybright/Desktop/SpatialDataandMapping/elev_output.tif")
st_crs(Elevation)
plot(Elevation)

# Import aspect
Aspect <- raster("/Users/swaybright/Desktop/SpatialDataandMapping/aspect_output.tif")
st_crs(Aspect)
plot(Aspect)

# Import slope
Slope <- raster("/Users/swaybright/Desktop/SpatialDataandMapping/slope_output.tif")
st_crs(Slope)
plot(Slope)

# Import GAP landcover data
GAPCover <- raster("/Users/swaybright/Desktop/SpatialDataandMapping/GAP_output.tif")
st_crs(GAPCover)
plot(GAPCover)
